...
#define BL_XRAM_ADDR 0x40000000
...
#define BL_D0_NET_IPI_IDX 0
#define BL_D0_NET_EVENT(raw_status) (raw_status >> (EVENT_MAX * BL_D0_NET_IPI_IDX))
#define BL_M0_NET_IPI_IDX 0
